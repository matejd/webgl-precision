all:
	emcc main.cpp common.cpp renderer.cpp stb_image.cpp -s TOTAL_MEMORY=134217728 -s EXPORTED_FUNCTIONS="['_main','_setAppValue']" -o build/index.html -std=c++11 -I. --preload-file assets
